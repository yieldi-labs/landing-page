...
const Hero = () => (
    <section>
        <div className="text-gray-600 mt-28 flex flex-col h-screen w-full">
            <div className="text-center flex-col flex flex-1 fixed w-full">
                <div className="text-[#332B29] text-center font-bold text-[76px] xl:text-[96px] leading-none max-w-[990px] mx-auto font-gt-america-ext">
                ...
                <div className="flex mt-20 z-0 w-full flex-1 flex-col md:flex-row md:items-stretch items-center">
                    ...
                    <div className="xl:ml-7 flex flex-col xl:mt-10 sm:px-2 flex-1 px-4 xl:px-0 justify-between h-auto">
                        <span />
                        <div className="text__color--main text-3xl text-left font-medium font-gt-america-ext max-w-[520px] pl-12 leading-[44px]">
